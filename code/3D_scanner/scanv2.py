...
def record_z_line(z_step, height, step_dir_pin, step_dir_state, step_step_pin, write_flag, file_to_write_to, lidar_to_origin_dist):
...
def main():
    ...
    old_file = 'cylindrical_points_v2.txt'
    new_file = 'rotated_points_v2.txt'
    cartesian_file = 'cartesian_points_v2.txt'
    ...
    while int(angle) < FINAL_ANGLE:   #until part has turned an angle of FINAL_ANGLE
        ...
        if write_flag == 1:   #this means overwrite
            record_z_line(Z_STEP, HEIGHT, Z_STEP_DIR_PIN, Z_STEP_DIR_STATE, Z_STEP_STEP_PIN, write_flag, old_file, LIDAR_TO_ORIGIN_DIST) 
            write_flag = 0
